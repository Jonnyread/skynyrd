...
get '/lesson/1' do
  Twilio::TwiML::Response.new do |r|
    ...
    r.Play 'https://s3-us-west-2.amazonaws.com/skynyrd/1-05+Simple+Man.m4a'
...
get '/lesson/2' do
  Twilio::TwiML::Response.new do |r|
    ...
    r.Play 'https://s3-us-west-2.amazonaws.com/skynyrd/2-09+Searchin%27.m4a'
...
get '/lesson/3' do
  Twilio::TwiML::Response.new do |r|
    ...
    r.Play 'https://s3-us-west-2.amazonaws.com/skynyrd/1-14+That+Smell.m4a'
...
get '/lesson/4' do
  Twilio::TwiML::Response.new do |r|
    ...
    r.Play 'https://s3-us-west-2.amazonaws.com/skynyrd/1-15+Free+Bird.m4a'
...
get '/lesson/5' do
  Twilio::TwiML::Response.new do |r|
    ...
    r.Play 'https://s3-us-west-2.amazonaws.com/skynyrd/1-03+Tuesday%27s+Gone.m4a'
...
get '/lesson/6' do
  Twilio::TwiML::Response.new do |r|
    ...
    r.Play 'https://s3-us-west-2.amazonaws.com/skynyrd/2-04+Mr.+Banker+(Single+Version).m4a'
